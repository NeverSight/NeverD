//===- SBFSemantics.h - Normalized Solana SBF semantics ---------*- C++ -*-===//
//
// NeverD Decompiler
//
//===----------------------------------------------------------------------===//
...
#ifndef NEVERD_SBF_RUNTIME_SBFSEMANTICS_H
#define NEVERD_SBF_RUNTIME_SBFSEMANTICS_H
...
#endif // NEVERD_SBF_RUNTIME_SBFSEMANTICS_H
