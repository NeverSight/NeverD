//===- KnownAddresses.h - Well-known Solana addresses ---------*- C++ -*-===//
//
// NeverD Decompiler
//
//===----------------------------------------------------------------------===//
...
#ifndef NEVERD_SBF_KNOWNADDRESSES_H
#define NEVERD_SBF_KNOWNADDRESSES_H
...
#include "neverd/sbf/SBFKnownAddressCategories.def"
};

enum class KnownAddress : uint8_t {
#define SBF_KNOWN_ADDRESS(ID, NAME, ADDRESS, CATEGORY) ID,
#include "neverd/sbf/SBFKnownAddresses.def"
  Unknown,
};
...
#endif // NEVERD_SBF_KNOWNADDRESSES_H
