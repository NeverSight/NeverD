//===- SBFAnchor.h - Anchor framework discriminators ------------*- C++ -*-===//
//
// NeverD Decompiler
//
//===----------------------------------------------------------------------===//
...
#ifndef NEVERD_SBF_SOLANA_SBFANCHOR_H
#define NEVERD_SBF_SOLANA_SBFANCHOR_H
...
#endif // NEVERD_SBF_SOLANA_SBFANCHOR_H
