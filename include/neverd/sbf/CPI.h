//===- CPI.h - Cross-program invocation ABI and decoding ------*- C++ -*-===//
//
// NeverD Decompiler
//
//===----------------------------------------------------------------------===//
...
#ifndef NEVERD_SBF_CPI_H
#define NEVERD_SBF_CPI_H
...
const ProgramInstructionInfo *findProgramInstruction(KnownAddress Program,
