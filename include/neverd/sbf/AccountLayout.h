//===- AccountLayout.h - The buffer the loader hands a program *- C++ -*-===//
//
// NeverD Decompiler
//
//===----------------------------------------------------------------------===//
...
#ifndef NEVERD_SBF_ACCOUNTLAYOUT_H
#define NEVERD_SBF_ACCOUNTLAYOUT_H
...
#endif // NEVERD_SBF_ACCOUNTLAYOUT_H
