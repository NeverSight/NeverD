//===- EVMSolidityEmitter.h - EVM to recovered Solidity backend -*- C++ -*-===//
//
// NeverD Decompiler
//
//===----------------------------------------------------------------------===//
...
#ifndef NEVERD_EVM_EMIT_EVMSOLIDITYEMITTER_H
#define NEVERD_EVM_EMIT_EVMSOLIDITYEMITTER_H
...
#endif // NEVERD_EVM_EMIT_EVMSOLIDITYEMITTER_H
