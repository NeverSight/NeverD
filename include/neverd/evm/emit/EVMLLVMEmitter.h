//===- EVMLLVMEmitter.h - EVM to LLVM i256 backend ------------*- C++ -*-===//
//
// NeverD Decompiler
//
//===----------------------------------------------------------------------===//
...
#ifndef NEVERD_EVM_EMIT_EVMLLVMEMITTER_H
#define NEVERD_EVM_EMIT_EVMLLVMEMITTER_H
...
#endif // NEVERD_EVM_EMIT_EVMLLVMEMITTER_H
