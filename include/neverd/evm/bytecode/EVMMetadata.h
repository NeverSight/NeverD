//===- EVMMetadata.h - The compiler metadata trailer ----------*- C++ -*-===//
//
// NeverD Decompiler
//
//===----------------------------------------------------------------------===//
...
#ifndef NEVERD_EVM_BYTECODE_EVMMETADATA_H
#define NEVERD_EVM_BYTECODE_EVMMETADATA_H
...
#endif // NEVERD_EVM_BYTECODE_EVMMETADATA_H
