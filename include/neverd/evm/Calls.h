//===- Calls.h - Calls into another program -------------------*- C++ -*-===//
//
// NeverD Decompiler
//
//===----------------------------------------------------------------------===//
...
#ifndef NEVERD_EVM_CALLS_H
#define NEVERD_EVM_CALLS_H
...
#define EVM_CALL_FAMILY(ID, OPCODE, VALUE_OPERAND, DELEGATES, STATIC, SUMMARY) \
  ID,
#include "neverd/evm/EVMCalls.def"
};
...
#include "neverd/evm/EVMPrecompiles.def"
};
