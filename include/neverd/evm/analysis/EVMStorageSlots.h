//===- EVMStorageSlots.h - Storage slots a specification fixes -*- C++ -*-===//
//
// NeverD Decompiler
//
//===----------------------------------------------------------------------===//
...
#ifndef NEVERD_EVM_ANALYSIS_EVMSTORAGESLOTS_H
#define NEVERD_EVM_ANALYSIS_EVMSTORAGESLOTS_H
...
#include "neverd/evm/analysis/EVMKnownSlots.def"
};
...
#endif // NEVERD_EVM_ANALYSIS_EVMSTORAGESLOTS_H
