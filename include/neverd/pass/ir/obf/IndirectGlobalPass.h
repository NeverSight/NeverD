...
/// transform fully orthogonal to the relocation/rewrite backend (L1): it scopes
/// to defined globals so the materialised address is an in-image, PC-relative
/// reference the address model resolves without a GOT, and runs after
/// symbolization, before codegen.
///
//===----------------------------------------------------------------------===//

#ifndef NEVERD_PASS_IR_OBF_INDIRECTGLOBALPASS_H
#define NEVERD_PASS_IR_OBF_INDIRECTGLOBALPASS_H
...
#endif // NEVERD_PASS_IR_OBF_INDIRECTGLOBALPASS_H
