...
/// The volatile slot guarantees the round-trip survives to the machine code
/// (the backend cannot elide a volatile load/store), so the value really does
/// detour through the stack while staying bit-for-bit equivalent.
///
//===----------------------------------------------------------------------===//

#ifndef NEVERD_PASS_IR_OBF_VALUELAUNDERINGPASS_H
#define NEVERD_PASS_IR_OBF_VALUELAUNDERINGPASS_H
...
#endif // NEVERD_PASS_IR_OBF_VALUELAUNDERINGPASS_H
