...
DockBase.TitleBarBase {
    ...
    RowLayout {
        ...
        WorkbenchButton { text: "↗"; implicitHeight: 25; implicitWidth: 28; visible: root.floatButtonVisible; hint: qsTr("Float or Dock Panel"); onClicked: root.floatButtonClicked() }
        WorkbenchButton { text: "×"; implicitHeight: 25; implicitWidth: 28; enabled: root.closeButtonEnabled; hint: qsTr("Close Panel"); onClicked: root.closeButtonClicked() }
    }
}
