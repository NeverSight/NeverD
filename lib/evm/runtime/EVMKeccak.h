//===- EVMKeccak.h - Ethereum's Keccak-256 permutation --------*- C++ -*-===//
//
// NeverD Decompiler
//
//===----------------------------------------------------------------------===//
...
#ifndef NEVERD_LIB_EVM_RUNTIME_EVMKECCAK_H
#define NEVERD_LIB_EVM_RUNTIME_EVMKECCAK_H
...
#endif // NEVERD_LIB_EVM_RUNTIME_EVMKECCAK_H
