...
/// and ordinary successor linking.  Exceptional successor linking lives in
/// CFGBuilderException.cpp, function entry-point detection in FuncDetector.cpp,
/// and jump-table resolution in JumpTableResolver.cpp.
///
//===----------------------------------------------------------------------===//
