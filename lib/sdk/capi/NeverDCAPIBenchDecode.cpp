//===- NeverDCAPIBenchDecode.cpp - C API: decode throughput bench ---------===//
//
// NeverD Decompiler
//
//===----------------------------------------------------------------------===//
///
/// \file
/// Raw instruction-decode throughput benchmark: times the single-threaded and
/// multi-threaded decode passes over the loaded image's executable segments
/// and returns JSON rate data.
///
//===----------------------------------------------------------------------===//
