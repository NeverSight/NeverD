...
TEST(SwiftMetadata, EmptyStructRejectsNontrivialValueWitnessStorageAndTraits) {
  ...
  const Case Cases[] = {
      {0x1640, 1, true},           {0x1640, UINT64_MAX, true},
      {0x1648, 0, true},           {0x1648, 2, true},
      {0x1648, UINT64_MAX, true},  {0x1650, 1, false},
      {0x1650, 7, false},          {0x1650, 15, false},
      {0x1650, 0x10000, false},    {0x1650, 0x20000, false},
      {0x1650, 0x40000, false},    {0x1650, 0x80000, false},
      {0x1650, 0x100000, false},   {0x1650, 0x200000, false},
      {0x1650, 0x400000, false},   {0x1650, 0x800000, false},
      {0x1650, 0x1000000, false},  {0x1650, 0x2000000, false},
      {0x1650, 0x80000000, false}, {0x1654, 1, false},
