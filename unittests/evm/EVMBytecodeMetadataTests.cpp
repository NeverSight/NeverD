//===- EVMBytecodeMetadataTests.cpp - EVM metadata trailer tests ---------===//
//
// NeverD Decompiler
//
//===----------------------------------------------------------------------===//
///
/// \file
/// What the trailer a compiler appends says about the build, and which byte
/// sequences are not a trailer at all.
///
//===----------------------------------------------------------------------===//
