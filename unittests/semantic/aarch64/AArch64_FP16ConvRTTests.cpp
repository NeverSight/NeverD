...
static const std::vector<RoundTripTC> kA64 = {
  ...
  // Fixed-point forms must apply the scale before the single FP16 rounding.
  {"scvtf_h_w_fixed_16",
   "long f(long a){unsigned int r;"
   "__asm__ volatile(\"scvtf h0,%w1,#16\\n fmov %w0,s0\":\"=r\"(r):\"r\"((int)a):\"v0\");"
   "return (long)r;}\n",
   {65536ULL}, FP16FLAGS},

  {"ucvtf_h_w_fixed_16",
   "long f(long a){unsigned int r;"
   "__asm__ volatile(\"ucvtf h0,%w1,#16\\n fmov %w0,s0\":\"=r\"(r):\"r\"((unsigned)a):\"v0\");"
   "return (long)r;}\n",
   {65536ULL}, FP16FLAGS},

  // Rounding this input to binary64 before scaling produces 0x3402; the
  // instruction performs one direct rounding and produces 0x3401.
  {"scvtf_h_x_fixed_64_midpoint",
   "long f(long a){unsigned int r;"
   "__asm__ volatile(\"scvtf h0,%1,#64\\n fmov %w0,s0\":\"=r\"(r):\"r\"(a):\"v0\");"
   "return (long)r;}\n",
   {4618441417868443647ULL}, FP16FLAGS},
  ...
  {"fcvtzs_w_h_fixed_16",
   "long f(long a){int r;"
   "__asm__ volatile(\"fmov s0,%w1\\n fcvtzs %w0,h0,#16\":\"=r\"(r):\"r\"((unsigned)a):\"v0\");"
   "return (long)r;}\n",
   {0x3C00ULL}, FP16FLAGS},

  {"fcvtzu_w_h_fixed_16",
   "long f(long a){unsigned int r;"
   "__asm__ volatile(\"fmov s0,%w1\\n fcvtzu %w0,h0,#16\":\"=r\"(r):\"r\"((unsigned)a):\"v0\");"
   "return (long)r;}\n",
   {0x3C00ULL}, FP16FLAGS},
  ...
  {"scvtf_4h_fixed_16",
   "long f(long a){unsigned long r;"
   "__asm__ volatile(\"fmov d0,%1\\n scvtf v0.4h,v0.4h,#16\\n fmov %0,d0\":\"=r\"(r):\"r\"((unsigned long)a):\"v0\");"
   "return (long)r;}\n",
   {0x80007FFFFFFF0001ULL}, FP16FLAGS},
  ...
  {"fcvtzs_4h_fixed_16",
   "long f(long a){unsigned long r;"
   "__asm__ volatile(\"fmov d0,%1\\n fcvtzs v0.4h,v0.4h,#16\\n fmov %0,d0\":\"=r\"(r):\"r\"((unsigned long)a):\"v0\");"
   "return (long)r;}\n",
   {0xB800380081000100ULL}, FP16FLAGS},
};
// clang-format on
