...
// return value.  CFINV requires FlagM, so select Unicorn's MAX CPU explicitly;
// Unicorn's default is intentionally a narrower A72 model.
//
//===----------------------------------------------------------------------===//
...
static const std::vector<RoundTripTC> kA64 = {
  ...
  {"cfinv_double",
   ...
   "__asm__ volatile(\"cmp %1,%2\\n\\tcfinv\\n\\tcfinv\\n\\tcset %w0,cs\""
   ":\"=r\"(c):\"r\"(a),\"r\"(b):\"cc\");return (long)c;}\n",
   {9, 2}, "Cfinv", 0, "-march=armv8.4-a", false, "",
   UC_CPU_ARM64_MAX},
