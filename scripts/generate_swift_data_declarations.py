#!/usr/bin/env python3
"""Extract standard Swift metadata and witness storage identities from queries.
...
def render(profiles, exports, version, compiler):
    ...
    lines = ["// clang-format off",
             ...
             f"// Compiler-derived external metadata/witness storage: MacOSX SDK {version}.",
             "// " + compiler.replace("\n", "; "),
             "// Target profiles: " + ", ".join(TARGETS),
             "// Direct non-TLS global addresses; no metadata/witness layout or implementation."]
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='neverd-swift-data-') as work:
        ...
        for index, target in enumerate(TARGETS):
            ...
            profiles.append(metadata | witness_storage(text, witnesses, metadata))
