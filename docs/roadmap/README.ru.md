...
| Аудит и охота на ошибки безопасности памяти | Phase 1 завершена — анализ P0/P1, свидетельство воспроизведения и матрица нативных форматов/архитектур готовы; P2 запланирована |
