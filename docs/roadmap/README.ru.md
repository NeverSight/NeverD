...
| Аудит и охота на ошибки безопасности памяти | Phase 1 завершена — анализ P0/P1 и свидетельство воспроизведения готовы; подтверждённые повтором LowIR concolic регистровые seed реализованы как основа P2, остальная оркестрация P2 запланирована |
