...
| تدقيق وصيد أمان الذاكرة | اكتملت Phase 1 — تحليل P0/P1 ودليل إعادة التشغيل موجودان؛ هبطت بذور سجلات LowIR concolic المتحقق منها بإعادة التشغيل كأساس P2، وتبقى بقية أعمال التنسيق مخططة |
