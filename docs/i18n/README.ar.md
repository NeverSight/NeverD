...
عند إعادة توزيع نسخ أو تعديلات من شيفرة NeverD المشمولة بـ AGPL، يجب الاحتفاظ بإشعارات حقوق النشر والترخيص وفقًا لـ AGPL؛ ويشمل ذلك إعادة الاستخدام بمساعدة الذكاء الاصطناعي أو النماذج اللغوية الكبيرة (AI/LLM)، والتحويلات باستخدام LLVM. ولتسهيل تتبّع المصدر، نوصي أيضًا بذكر المستودع والملفات والإصدار المستخدم. راجع [دليل الإسناد وذكر المصادر](ATTRIBUTION.ar.md)، و[NOTICE](../../NOTICE)، و[CITATION.cff](../../CITATION.cff).
