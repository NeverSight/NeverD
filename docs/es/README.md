...
| [Emulación de controladores de Windows](driver-emulation.md) | Inicialización WDM x64 acotada, solicitudes seriales buffered/direct, finalización por elementos de trabajo, informes y límites |
