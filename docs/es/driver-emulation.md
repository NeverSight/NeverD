...
| Controlador KMDF 1.33 no PnP | Vinculación, objetos/contextos, dispositivos de control con nombre, colas secuenciales predeterminadas y solicitudes con búfer/directas con callbacks ejecutados | Sin dispositivos PnP, cancelación, planificación general de colas, extensiones de clase ni UMDF |
...
`wdm-x64-scheduled-v4`. `nt_status` sigue siendo el resultado de DriverEntry,
