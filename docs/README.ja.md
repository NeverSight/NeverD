...
[← NeverD プロジェクト](i18n/README.ja.md)
...
| 文書 | 説明 |
|------|------|
| [プロジェクト説明（日本語）](i18n/README.ja.md) | 概要、クイックスタート、ビルド、SDK、CLI |
| [貢献ガイド](i18n/CONTRIBUTING.ja.md) | 開発環境、ビルドプロファイル、ワークフロー、スタイル、PR 要件 |
...
| [ネイティブプラグイン](plugins.ja.md) | 純粋 C descriptor ABI、callback と event、build/link workflow、discovery、互換性規則 |
