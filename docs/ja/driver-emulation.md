...
| ハードウェア、DMA、PCI、割り込み、仮想化を扱うドライバー | 明示的なメモリレジスターバンク、MMIO、排他的 latched 割り込み、コヒーレント共通バッファー／SG DMA に対応 | その他のデバイスモデル、任意物理 RAM、PCI、ポート、その他の割り込みモード、その他の DMA インターフェース、特権 CPU 状態 |
