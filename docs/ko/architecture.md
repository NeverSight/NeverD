...
- selector 전용 Objective-C stub은 호출이 고정 인자 prefix에서 끝날 때만 동적 format을 바인딩할 수 있습니다. 추가 실인자, 부정확한 stub, 선언 충돌 또는 물리 ABI 불일치는 미해결로 남습니다.
