**語言**: [English](../plugins.md) | [简体中文](../zh-CN/plugins.md) | [繁體中文](plugins.md) | [日本語](../ja/plugins.md) | [한국어](../ko/plugins.md) | [Français](../fr/plugins.md) | [Deutsch](../de/plugins.md) | [Español](../es/plugins.md) | [Italiano](../it/plugins.md) | [Русский](../ru/plugins.md) | [العربية](../ar/plugins.md)
...
撰寫擴充功能，請參閱 [Python 外掛指南](python-plugins.md)。
