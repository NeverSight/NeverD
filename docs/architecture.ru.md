...
Реализации runtime, памяти, IR и аудита объектов определяют и проверяют эти
границы. Они не образуют полного исполняемого backend трансляции, полной
pipeline межархитектурной трансляции или полного сквозного переписывания
исключений. Этот раздел описывает область контракта и verifier; он не заявляет
о сквозной доступности генерации, линковки, загрузки, исполнения, JIT, AOT или
переписывания исключений.
