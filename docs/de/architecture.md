...
Die Qualifizierung eines Swift-Bool-Ergebnisses verbindet das aktuelle Objective-C-Eingangs-ABI, unveränderliche direkte Aufrufbytes, den exakten starken Laufzeitimport und den vollständigen LowIR-Verbrauchernachweis. Sie erlaubt eine Vergleichsstelle und rekonstruiert alle anderen Aufruf-ABIs aus dem aktuellen Laufzeitkatalog; native Vermutungen, dynamischer Dispatch und doppelte Aufrufstellen werden abgelehnt. Dieser Nachweis allein veröffentlicht weder Quellcode noch ein Byte-Rückgabe-ABI.
