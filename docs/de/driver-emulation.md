...
| Hardware-, DMA-, PCI-, Interrupt- oder Virtualisierungstreiber | Explizite Speicherregisterbank und MMIO unterstützt | Weitere Gerätemodelle, beliebiger physischer RAM, PCI, Ports, Interrupts, DMA und privilegierter CPU-Zustand |
...
Profil lautet `wdm-x64-scheduled-v12`. `nt_status` bleibt das
