...
| Hardware-, DMA-, PCI-, Interrupt- oder Virtualisierungstreiber | Explizite Speicherregisterbank, MMIO und exklusive Latched-Interruptcallbacks unterstützt | Weitere Gerätemodelle, beliebiger physischer RAM, PCI, Ports, andere Interruptmodi, DMA und privilegierter CPU-Zustand |
...
Profil lautet `wdm-x64-scheduled-v13`. `nt_status` bleibt das
