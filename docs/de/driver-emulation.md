...
| KMDF-1.33-Nicht-PnP-Treiber | Bindung, Objekte/Kontexte, benannte Steuergeräte, sequenzielle oder unbegrenzte parallele Standardwarteschlangen sowie gepufferte/direkte/neither Anforderungen mit ausgeführten Callbacks | Keine PnP-Geräte, allgemeine Warteschlangenplanung, Klassenerweiterungen oder UMDF |
...
Das begrenzte Modell ist keine vollständige asynchrone Windows-Umgebung. Alertable-/User-Mode-Warten, APCs, allgemeiner WDM-Anforderungsabbruch, gleichzeitige öffentliche Szenarioeinreichungen, UMDF, KMDF-PnP-Geräte und allgemeine Warteschlangenplanung, vollständiges PnP/Power, allgemeine Hardwaremodelle, weitere DMA-Schnittstellen und andere Interruptmodi bleiben unmodelliert. Reine Initialisierung führt explizit eingereihte Callbacks aus, erzeugt aber keine Anforderungen oder implizites Entladen.
...
Profil lautet `wdm-x64-scheduled-v36`. `nt_status` bleibt das
