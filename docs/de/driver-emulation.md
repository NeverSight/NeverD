...
| PnP-Bus-, Funktions- oder Filtertreiber | Explizite ressourcenfreie PDOs, Gast-AddDevice und acht übliche PnP-Lebenszyklusfunktionen | Weitere PnP-Vorgänge, Power-IRPs, Hardware/Ressourcen und KMDF-PnP |
...
Profil lautet `wdm-x64-scheduled-v9`. `nt_status` bleibt das
