...
| [Émulation des pilotes Windows](driver-emulation.md) | Initialisation WDM x64 bornée, requêtes sérielles bufferisées/directes, achèvement par élément de travail, rapports et limites |
