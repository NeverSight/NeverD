...
| MDL alloués par le pilote | Descripteurs de pool/utilisateur autonomes ou associés à un IRP ; liens invités et libération à la complétion | Quotas, MDL manuels/partiels et mappings utilisateur arbitraires |
