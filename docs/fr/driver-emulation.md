...
| Pilote PnP de bus, de fonction ou de filtre | PDO explicites sans ressources, AddDevice invité et huit fonctions mineures courantes du cycle PnP | Autres opérations PnP, IRP d’alimentation, matériel/ressources et KMDF PnP |
...
`wdm-x64-scheduled-v9`. `nt_status` reste le résultat de DriverEntry, tandis
