...
| MDL allocati dal driver | Descrittori di pool/utente autonomi o associati a IRP; collegamenti guest e rilascio al completamento | Quote, MDL manuali/parziali e mapping utente arbitrari |
