...
| Driver KMDF 1.33 non PnP | Binding, oggetti/contesti, dispositivi di controllo con nome, code sequenziali predefinite e richieste con buffer/dirette con callback eseguiti | Nessun dispositivo PnP, annullamento, pianificazione generale delle code, estensione di classe o UMDF |
...
Il profilo è `wdm-x64-scheduled-v4`. `nt_status` rimane il risultato di DriverEntry,
