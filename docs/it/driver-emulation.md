...
| Driver PnP di bus, funzione o filtro | PDO espliciti senza risorse, AddDevice guest e otto funzioni minori comuni del ciclo PnP | Altre operazioni PnP, IRP di alimentazione, hardware/risorse e KMDF PnP |
...
Il profilo è `wdm-x64-scheduled-v9`. `nt_status` rimane il risultato di DriverEntry,
