...
| Driver hardware, DMA, PCI, di interrupt o di virtualizzazione | Banchi di registri, MMIO e callback di interrupt latched esclusivi dichiarati esplicitamente | Altri modelli di dispositivi, RAM fisica, PCI, porte, interrupt condivisi/di livello/MSI, DMA e stato CPU privilegiato |
...
Il profilo è `wdm-x64-scheduled-v13`. `nt_status` rimane il risultato di DriverEntry,
