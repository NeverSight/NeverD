...
| Hardware, DMA, PCI, interrupt or virtualization driver | Explicit register banks, MMIO, exclusive latched interrupts and bounded coherent common/SG DMA | Other device models, host physical RAM, PCI, ports, shared/level/MSI interrupts, other DMA interfaces and privileged CPU state |
...
The profile is `wdm-x64-scheduled-v14`. `nt_status` remains the DriverEntry
