...
| KMDF 1.33 resource-free PnP FDO | `EvtDriverDeviceAdd`, FDO/PDO identity, explicit non-power-managed I/O queues, common PnP minors, hardware/D0 callbacks and framework cleanup | Resource-bearing FDOs, queue power transitions, other power callbacks and general KMDF PnP |
...
The profile is `wdm-x64-scheduled-v52`. `nt_status` remains the DriverEntry
