...
| KMDF 1.33 PnP FDO | `EvtDriverDeviceAdd`, FDO/PDO identity, default or explicit power-managed I/O queues, common PnP minors, hardware/D0 callbacks and framework cleanup | Unmodeled resource types, stop/resume of driver-held requests, other power callbacks and general KMDF PnP |
...
The profile is `wdm-x64-scheduled-v54`. `nt_status` remains the DriverEntry
