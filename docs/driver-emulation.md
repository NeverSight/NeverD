...
| KMDF 1.33 resource-free PnP FDO | `EvtDriverDeviceAdd`, FDO/PDO identity, default or explicit power-managed I/O queues, common PnP minors, hardware/D0 callbacks and framework cleanup | Resource-bearing FDOs, stop/resume of driver-held requests, other power callbacks and general KMDF PnP |
...
The profile is `wdm-x64-scheduled-v53`. `nt_status` remains the DriverEntry
