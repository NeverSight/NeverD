...
| PnP 总线／功能／过滤驱动 | 显式无资源 PDO、来宾 AddDevice 和八种常见 PnP 生命周期次功能 | 其他 PnP 操作、电源 IRP、硬件／资源及 KMDF PnP |
