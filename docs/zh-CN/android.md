...
[Mobile Decompilation 工作流](../../.github/workflows/mobile.yml) 在 Linux、macOS、Windows 的 Python 3.10 和 3.13 上运行组件测试，并在 Linux 使用校验和固定的真实 Android 后端。独立的 iOS 工作流及当前限制见[移动应用总览](mobile.md)。
