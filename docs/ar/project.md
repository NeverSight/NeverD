...
يستعيد الأمر التجريبي `neverd mobile app.apk -o recovered-app` شيفرة Java من APK وDEX وsmali باستخدام محرك NeverD المدمج وPython 3.10+ افتراضيًا، دون الحاجة إلى Java أو JADX وقت التشغيل. يختار `--jadx PATH` الصريح المحوّل الخارجي الاختياري؛ ولا يوجد انتقال تلقائي. لا تضيف هذه الميزة دعم APK أو Java إلى SDK أو محمّل الواجهة الرسومية. راجع [دليل استعادة Java من Android](android.md) للإعداد والمدخلات والتقارير وحدودها.
