...
يتلقى وارد libswiftCore الدقيق `KEY_TYPE_OF_DICTIONARY_VIOLATES_HASHABLE_REQUIREMENTS` مؤشراً واحداً لبيانات النوع الوصفية ولا يعود أبداً، وفق تصريح Swift 6.1.2. لا يُمنح عقد الإنهاء هذا إلا لموفره وABI الموثقين؛ ويظل الاستدعاء الأصلي والتعليمة الفخ في مسار المصدر.
