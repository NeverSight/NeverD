...
يجوز لمدخل أصلي ذي رمز دالة عند عنوانه الدقيق في الصورة أن يفترض مؤقتًا أن كلمة x0 الكاملة وحدها قابلة للملاحظة. بعد أن يربط استنتاج المصدر ABI الكامل للمدخل، يعيد النشر إثبات LowIR نفسه باستخدام ذلك ABI؛ ولا يمنح هذا الافتراض المؤقت وحده ربطًا للمصدر أو ABI لإرجاع بايت.
