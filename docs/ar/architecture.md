...
يتتبع إثبات النتيجة المنطقية بتات الاختلاف عبر الإزاحات الصحيحة الثابتة إلى اليسار واليمين المنطقي واليمين الحسابي ضمن عرض المعامل، وعبر نتائج العمليات البتية المقتطعة إلى وجهة أصغر. يغطي ذلك اختبارات البت في ARM64 دون اعتبار بتات الحشو غير المرصودة معرّفة. تبقى الإزاحات المتغيرة أو الخارجة عن النطاق مرفوضة، ويُرفض التطبيع إذا أثرت بتات الحشو المزاحة في فرع أو وسيطة أو كتابة أو قيمة معادة.
