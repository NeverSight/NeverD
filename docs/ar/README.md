...
يدعم NeverD منصتي Android وiOS عبر واجهة سطر الأوامر التجريبية `neverd mobile`: من APK (بما فيه multidex) وDEX وملفات smali أو مجلداتها إلى Java مع تقرير JSON؛ ومن IPA و`.app` وMach-O ‏(arm64/x86_64) إلى شيفرة C أصلية ومصادر Objective-C/Swift المدعومة مع تقرير تغطية JSON. يتوقف نطاق الاستعادة على أنماط الشيفرة المدعومة، وتوضح الأدلة القيود.
...
| [محاكاة برامج تشغيل Windows](driver-emulation.md) | تهيئة x64 WDM محدودة وطلبات buffered/direct متسلسلة وعناصر عمل ومؤقتات وDPC وأحداث وانتظار وتقارير وحدود |
...
| [نظرة عامة على mobile (English)](../mobile.md) | واجهة سطر الأوامر التجريبية لـAndroid وiOS، والمدخلات والمخرجات والتقارير والقيود |
