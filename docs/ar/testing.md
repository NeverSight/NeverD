...
تتحقق الاختبارات الإضافية من سياقات CPU الكاملة (السجلات والأعلام وSIMD وFPU وCR8) والذاكرة المشتركة ورفض السياقات بعد العطل أو من خلفية أخرى. تغطي عينات العمل IRP المعلّمة كمعلّقة والإكمال المؤجل وأخطاء الطابور والعمر والتوقف والميزانيات المشتركة وحالتي الإرسال والإكمال المنفصلتين في التقارير العامة. تختبر المؤقتات/DPC الداخلية انتقالات الحالة فقط، لا واجهات الضيف أو بيئة Windows غير المتزامنة الكاملة.
