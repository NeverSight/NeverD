**اللغات**: [English](../../CONTRIBUTING.md) | [简体中文](../zh-CN/CONTRIBUTING.md) | [繁體中文](../zh-TW/CONTRIBUTING.md) | [日本語](../ja/CONTRIBUTING.md) | [한국어](../ko/CONTRIBUTING.md) | [Français](../fr/CONTRIBUTING.md) | [Deutsch](../de/CONTRIBUTING.md) | [Español](../es/CONTRIBUTING.md) | [Italiano](../it/CONTRIBUTING.md) | [Русский](../ru/CONTRIBUTING.md) | [العربية](CONTRIBUTING.md)
...
احتفظ بإشعارات حقوق النشر والترخيص والمصدر عند إدراج شفرة موجودة، بما في ذلك
الشفرة المنسوخة أو المعدّلة باستخدام أدوات الذكاء الاصطناعي أو النماذج اللغوية الكبيرة (AI/LLM).
اتبع [دليل نسبة العمل إلى أصحابه](ATTRIBUTION.md)، وحدد المصدر الأصلي
والمراجعة للمواد المعاد استخدامها، وتحقق من رخصتها قبل تقديمها.
أبقِ إشعارات الأطراف الثالثة خاضعة لرخصها الأصلية.

اقرأ [دليل العمارة](architecture.md) قبل التعديل. استخدم
[دليل الاختبارات](testing.md) لاختيار المجموعة، وراجع
[خارطة الطريق](roadmap/README.md) للعمل المخطط على المنتج.
...
يوثّق [دليل الاختبارات](testing.md) جميع الأهداف المريحة، ومجموعات التحويل
